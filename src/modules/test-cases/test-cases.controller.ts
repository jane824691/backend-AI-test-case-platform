...
export class TestCasesController {
  ...
  @Delete(':testCaseId')
  @RequirePermission(Permission.TestCaseDelete)
  delete(@Param('projectId') projectId: string, @Param('testCaseId') testCaseId: string) {
    return this.testCasesService.delete(projectId, testCaseId);
  }
